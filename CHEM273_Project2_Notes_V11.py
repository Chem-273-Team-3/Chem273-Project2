...
class Ecoli_Walk():
    ...
    def EcoliWalk_Simulation(self):
        ...
        self.AVG_final_Xpos = AVG_final_Xpos
        self.AVG_final_Ypos = AVG_final_Ypos
    ...
    #__________________________________________________________________________#
        ...
        plt.title(
        f"E.coli Paths with Food Gradient Background\n" 
        f"Total 'Run' Steps = {self.iterationCount}, Memory = {self.tumbles}\n"
        f"Learning Rate = {self.learning_R}, Gradient Type = {gradType}, "
        f"Optimization Type = {self.optimizeType}\n"
        f"Final X Pos = {self.AVG_final_Xpos}, Final Y Pos = {self.AVG_final_Ypos}")
        plt.xlabel("X Position (Distance Units)")  # Label for the x-axis
        plt.ylabel("Y Position (Distance Units)")  # Label for the y-axis
